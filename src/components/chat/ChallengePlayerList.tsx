...
export function ChallengePlayerList({ players, loading, onClose, onPlayerSelect }: ChallengePlayerListProps) {
        ...
        >
          ...
          <div className="p-4 border-b border-gray-700">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-white">Challenge Players</h2>
              <button
                onClick={onClose}
