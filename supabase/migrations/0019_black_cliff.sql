/*
  # Add Health Assessment FP Bonus

  1. Changes
    - Add health_assessment_bonus column to daily_fp
    - Update health assessment function to award FP bonus
...
ADD COLUMN IF NOT EXISTS health_assessment_bonus integer DEFAULT 0;

-- Create function to handle health assessment updates with FP bonus
