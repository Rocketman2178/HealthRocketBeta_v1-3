...
DROP FUNCTION IF EXISTS sync_fuel_points();
DROP FUNCTION IF EXISTS handle_level_up(uuid, integer);
DROP FUNCTION IF EXISTS calculate_next_level_points(integer);
