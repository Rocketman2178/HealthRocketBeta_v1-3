-- Create improved function to handle burn streak rewards
...
BEGIN
    ...
    -- Calculate next milestone and streak bonus
    IF v_burn_streak >= 21 THEN
        -- After 21, reset milestone tracking but keep counting streak
        v_next_milestone := 3;
        v_streak_bonus := 100;  -- Always 100 FP for maintaining 21+ streak
