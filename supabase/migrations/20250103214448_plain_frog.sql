-- Drop all existing verification functions
DROP FUNCTION IF EXISTS handle_verification_post(text, uuid, uuid);
DROP FUNCTION IF EXISTS handle_verification_post(text, uuid, uuid, integer);

-- Create single verification post handler
