-- Update health assessment function to properly set onboarding_completed
...
BEGIN
  ...
  -- Update user profile with latest scores, add FP bonus, and set onboarding_completed
  UPDATE users SET
