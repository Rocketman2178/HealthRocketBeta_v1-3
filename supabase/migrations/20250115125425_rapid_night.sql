-- Create improved function to handle streak bonuses
...
BEGIN
    ...
    -- IMPORTANT: Changed to check >= 3 first to ensure 3-day bonus is applied
    v_streak_bonus := CASE 
    ...
    -- Only apply streak bonus on first boost of the day
